                ...
                <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                    ...
                    <div className="md:7/12 lg:w-6/12">
                        ...
                        <p className="mt-6 text-gray-600 dark:text-gray-400">
                            Greetings. I’m <Link className='hover:text-indigo-950 dark:hover:text-gray-200 font-medium' to="https://github.com/Z0RRR0">{data.name}</Link> — a highly functional web developer with a predilection for clean code, well-structured logic, and an unrelenting desire to learn (and occasionally refactor everything for fun).
